const CACHE='whatsup-dog-v12-smart-report-v3';
const CORE=['./','./index.html','./styles.css?v=5','./home.css?v=5','./app.js?v=5','./official-areas.js?v=7','./home.js?v=5','./smart-report.css?v=3','./smart-report-v3.js?v=3','./manifest.webmanifest','./icon.svg','./waldo-mark.png','./data/nijkerk-losloopgebieden.geojson'];
