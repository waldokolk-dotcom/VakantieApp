const CACHE='whatsup-dog-v13-community-backend';
const CORE=['./','./index.html','./styles.css?v=5','./home.css?v=5','./app.js?v=5','./official-areas.js?v=8','./home.js?v=5','./smart-report.css?v=3','./smart-report-v3.js?v=3','./backend-config.js?v=1','./community-backend.js?v=1','./manifest.webmanifest','./icon.svg','./waldo-mark.png','./data/nijkerk-losloopgebieden.geojson'];
