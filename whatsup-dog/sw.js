const CACHE='whatsup-dog-v10-smart-report';
const CORE=['./','./index.html','./styles.css?v=5','./home.css?v=5','./app.js?v=5','./official-areas.js?v=5','./home.js?v=5','./smart-report.css?v=1','./smart-report.js?v=1','./manifest.webmanifest','./icon.svg','./waldo-mark.png','./data/nijkerk-losloopgebieden.geojson'];
