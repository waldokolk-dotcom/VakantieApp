...
- `autosleutels aantal twee, klaar`
- `correctie, aantal moet drie zijn`
- `correctie autosleutels aantal twee`
- `zet autosleutels terug`

Op toestellen die de knop **Luister nu** niet ondersteunen, gebruik je de microfoon van het telefoontoetsenbord in het witte invoervak en tik je daarna op **Zoek genoemde items**.
